# Generated by Django 2.1.2 on 2019-04-17 19:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.CharField(choices=[('B.TECH - CSE', 'B.TECH - CSE'), ('B.TECH - IT', 'B.TECH - IT'), ('B.TECH - ECE', 'B.TECH - ECE'), ('M.TECH - CSE', 'M.TECH - CSE'), ('M.TECH - IT', 'M.TECH - IT'), ('M.TECH - ECE', 'M.TECH - ECE'), ('MCA', 'MCA')], max_length=20)),
                ...
                ('region', models.CharField(choices=[('Delhi', 'Delhi'), ('Outside Delhi', 'Outside Delhi')], max_length=20)),
                ('category', models.CharField(choices=[('Unreserved', 'Unreserved'), ('OBC', 'OBC'), ('SC', 'SC'), ('ST', 'ST'), ('OTH', 'Other')], max_length=20)),
