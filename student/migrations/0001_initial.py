# Generated by Django 2.1.2 on 2019-03-30 19:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('qualificaion', models.CharField(choices=[('Secondary', 'X (Secondary)'), ('SeniorSecondary', 'XII (Senior Secondary)')], max_length=20)),
                ('year', models.IntegerField(choices=[(2004, 2004), (2005, 2005), (2006, 2006), (2007, 2007), (2008, 2008), (2009, 2009), (2010, 2010), (2011, 2011), (2012, 2012), (2013, 2013), (2014, 2014), (2015, 2015), (2016, 2016), (2017, 2017), (2018, 2018), (2019, 2019)])),
                ('board', models.CharField(max_length=50)),
                ('school', models.CharField(max_length=100)),
                ('marks', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='Percentage/CGPA')),
            ],
        ),
        migrations.CreateModel(
            name='StudentProfile',
            fields=[
                ...
                ('admission_year', models.IntegerField(choices=[(2015, 2015), (2016, 2016), (2017, 2017), (2018, 2018), (2019, 2019)], verbose_name='Year of Admission')),
                ('passing_year', models.IntegerField(choices=[(2019, 2019), (2020, 2020), (2021, 2021), (2022, 2022), (2023, 2023)], verbose_name='Year of Passing Out')),
                ...
                ('primary_mobile', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(9999999999)], verbose_name='Mobile Number')),
